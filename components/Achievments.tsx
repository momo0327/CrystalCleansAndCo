...
const Achievements = () => {
  ...
  return (
    <section id='About' ref={sectionRef} className="py-24 px-6 bg-bgColor">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              <Badge className="bg-bgColor border border-[#002657] hover:bg-gray-100 text-gray-700 gap-2 px-4 py-2 mb-6">
                Om oss
              </Badge>
            </div>
